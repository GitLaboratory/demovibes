...
class SongAdmin(admin.ModelAdmin):
	...
	fieldsets = [
		("General"		,{ 'fields' : ['title', 'remix_of_id', 'file', 'artists', 'groups', 'labels']}),
		("Additional info"	,{ 'fields' : ['pouetid', 'wos_id', 'zxdemo_id', 'lemon_id', 'projecttwosix_id', 'hvsc_url', 'type', 'platform', 'status', 'info']}),
