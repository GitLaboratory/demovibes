...
class UploadForm(forms.ModelForm):
    class Meta:
        model = Song
        fields = ["title", "release_date", "file", "pouetid", "wos_id", "zxdemo_id", "projecttwosix_id", "lemon_id", "hol_id", "hvsc_url", "remix_of_id", "groups", "labels", "info", "type", "platform"]
...
class ProfileForm(forms.ModelForm):
    ...
    class Meta:
        model = Userprofile
        fields = ['infoline', 'visible_to', 'web_page', 'aol_id', 'yahoo_id', 'icq_id', 'twitter_id', 'hol_id', 'country', 'location', 'avatar', 'info', 'fave_id', 'email_on_pm', 'pm_accepted_upload', 'paginate_favorites', 'theme', 'custom_css']
